package com.whale.framework.operatelog.core.aop;
...
import com.whale.framework.operatelog.core.enums.OperateTypeEnum;
import com.whale.framework.operatelog.core.service.OperateLogFrameworkService;
...
import static com.whale.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static com.whale.framework.common.exception.enums.GlobalErrorCodeConstants.SUCCESS;
...
public class OperateLogAspect {
    ...
    private void log(ProceedingJoinPoint joinPoint, OperateLog operateLog, ApiOperation apiOperation,
        ...
        try {
            ...
            logger.error("[log][记录操作日志时，发生异常，其中参数是 joinPoint({}) operateLog({}) apiOperation({}) result({}) exception({}) ]",
